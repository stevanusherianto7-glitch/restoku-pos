...
Route::get('/oauth/google', [GoogleOAuthController::class, 'redirect'])->name('oauth.google');
Route::get('/oauth/google/callback', [GoogleOAuthController::class, 'callback'])->middleware('throttle:10,1')->name('oauth.google.callback');
