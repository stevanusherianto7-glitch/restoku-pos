    ...
    <div className="min-h-screen w-full bg-[#030303] flex font-display selection:bg-white/20">
      ...
      <div className="hidden lg:flex w-[42%] xl:w-[38%] shrink-0 flex-col justify-between p-14 bg-white/[0.015] border-r border-white/5 relative overflow-hidden">
        ...
        <div className="relative flex items-center gap-3">
          <div className="grid size-11 place-items-center rounded-2xl bg-white/5 border border-white/10">
            <ChefHat className="size-6 text-white" />
          </div>
          <div>
            <div className="text-xl font-bold text-white tracking-tight">Restoku OS</div>
            <div className="text-[10px] text-slate-500 uppercase tracking-widest">Sistem Manajemen Restoran</div>
          </div>
        </div>
