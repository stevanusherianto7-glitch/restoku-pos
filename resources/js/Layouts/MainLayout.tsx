...
const nav: NavGroup[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { name: 'Laba & Rugi', href: '/laporan/laba-rugi', phase: 2, roles: ['owner'] },
            { name: 'Laporan Produk', href: '/laporan/produk', phase: 2, roles: ['manager', 'owner'] },
            { name: 'Laporan Shift', href: '/laporan/shift', phase: 2, roles: ['manager', 'owner'] },
            { name: 'Laporan Meja', href: '/laporan/meja', phase: 2, roles: ['manager', 'owner'] },
            { name: 'Transaksi Void', href: '/laporan/void', phase: 2, roles: ['manager', 'owner'] },
        ],
    },
    {
        title: 'Keuangan',
        Icon: WalletIcon,
        roles: ['owner'],
        items: [{ name: 'Biaya Operasional', href: '/biaya-operasional', phase: 2, roles: ['owner'] }],
    },
    {
        title: 'Pengaturan',
        Icon: SettingsIcon,
    ...
    },
    {
        ...
        items: [
            ...
            { name: 'Kehadiran', href: '/owner/kehadiran', phase: 2, roles: ['owner'] },
            { name: 'Jadwal Shift', href: '/owner/jadwal-shift', phase: 2, roles: ['owner'] },
        ],
    },
];
