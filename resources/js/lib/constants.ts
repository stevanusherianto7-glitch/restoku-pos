...
export const PLAN_FEATURES: Record<Plan, string[]> = {
    basic: ['pbjt_tax', 'qris', 'gopay', 'bank_transfer', 'qrcode_order', 'thermal_print', 'email_notif'],
    pro: [
        'pbjt_tax',
        'ppn_tax',
        'service_charge',
...
// ─── Helper ───────────────────────────────────────────────────────────────────
export const planHasFeature = (plan: Plan, feature: string): boolean => PLAN_FEATURES[plan]?.includes(feature) ?? false;
