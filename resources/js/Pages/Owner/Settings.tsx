                ...
                <div className="lg:col-span-2 space-y-8">
                    <form onSubmit={handleSave}>
                        <Glass className="p-8">
                            ...
                            <div className="space-y-5">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-slate-400 mb-2">Nomor WhatsApp</label>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start gap-4 p-4 rounded-xl border border-white/5 bg-white/[0.02]">
                                    <div className="flex items-center h-6">
                                        <input id="notif-daily" type="checkbox" defaultChecked className="w-5 h-5 rounded border-white/20 bg-black/50 text-emerald-500 focus:ring-emerald-500 focus:ring-offset-slate-900" />
                                    </div>
                                    <div>
                                        <label htmlFor="notif-daily" className="font-medium text-white cursor-pointer block">Kirim laporan penjualan harian via WhatsApp</label>
                                        <p className="text-sm text-slate-400 mt-1">Ringkasan omzet, total transaksi, dan rata-rata pesanan harian.</p>
                                    </div>
                                </div>

                                <div className="flex items-start gap-4 p-4 rounded-xl border border-white/5 bg-white/[0.02]">
                                    <div className="flex items-center h-6">
                                        <input id="notif-stock" type="checkbox" defaultChecked className="w-5 h-5 rounded border-white/20 bg-black/50 text-emerald-500 focus:ring-emerald-500 focus:ring-offset-slate-900" />
                                    </div>
                                    <div>
                                        <label htmlFor="notif-stock" className="font-medium text-white cursor-pointer block">Peringatan stok habis via WhatsApp</label>
                                        <p className="text-sm text-slate-400 mt-1">Notifikasi instan jika ada bahan baku kritikal yang habis total.</p>
                                    </div>
                                </div>

                                <div className="flex items-start gap-4 p-4 rounded-xl border border-white/5 bg-white/[0.02]">
                                    <div className="flex items-center h-6">
                                        <input id="notif-contract" type="checkbox" className="w-5 h-5 rounded border-white/20 bg-black/50 text-emerald-500 focus:ring-emerald-500 focus:ring-offset-slate-900" />
                                    </div>
                                    <div>
                                        <label htmlFor="notif-contract" className="font-medium text-slate-200 cursor-pointer block">Peringatan kontrak karyawan via WhatsApp</label>
                                    </div>
                                </div>
                                
                                <div>
                                    <label className="block text-sm font-medium text-slate-400 mb-2">Waktu Pengiriman Laporan Harian</label>
                                    <input 
                                        type="time" 
                                        defaultValue="21:00" 
                                    ...
                                    />
                                    <p className="text-xs text-slate-500 mt-2">Laporan akan dikirim otomatis setiap hari pada jam tersebut.</p>
                                </div>
                            </div>
                        </Glass>
                        ...
                        <div className="mt-8 flex justify-end items-center gap-4">
                            ...
                            <button type="submit" className="flex items-center gap-2 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white px-8 py-3 rounded-xl font-bold shadow-lg shadow-blue-500/20 transition-all hover:scale-105 active:scale-95">
                ...
                <div className="space-y-6">
                    <Glass className="p-6 border-t-2 border-emerald-500/30">
                        ...
                        <div className="space-y-4">
                            ...
                            <button type="button" className="w-full flex justify-center items-center gap-2 bg-white/5 hover:bg-white/10 border border-white/10 text-white px-4 py-2.5 rounded-xl font-medium transition-colors mt-2">
                    ...
                    <div className="p-5 bg-gradient-to-br from-emerald-900/40 to-blue-900/20 border border-emerald-500/20 rounded-2xl">
                        ...
                        <button type="button" className="w-full py-2 bg-white text-black font-bold rounded-lg hover:bg-slate-200 transition-colors">
                            Kirim Link Download
                        </button>
                    </div>
                </div>
