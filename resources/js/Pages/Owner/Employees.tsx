...
export default function Employees() {
    ...
    const departments = [
        { name: "Service (Waiter)", head_count: 5, salary: 4200000, icon: UserCheck, color: "text-blue-400", bg: "bg-blue-500/20" },
        { name: "Kitchen", head_count: 7, salary: 6500000, icon: ChefHat, color: "text-emerald-400", bg: "bg-emerald-500/20" },
        { name: "Cashier", head_count: 2, salary: 1400000, icon: Calculator, color: "text-amber-400", bg: "bg-amber-500/20" },
        { name: "Management", head_count: 1, salary: 730580, icon: Briefcase, color: "text-purple-400", bg: "bg-purple-500/20" },
    ];
        ...
        <MainLayout>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <Glass className="p-6 flex flex-col items-center justify-center text-center">
                    ...
                    <p className="text-4xl font-black text-white">{overview.total_employees} <span className="text-lg font-medium text-slate-500">Orang</span></p>
                </Glass>
                ...
                <Glass className="p-6 flex flex-col items-center justify-center text-center">
                    ...
                    <p className="text-sm font-medium text-slate-400 uppercase tracking-widest mb-1">Total Gaji Bulan Ini</p>
                ...
                <Glass className="p-6 flex flex-col items-center justify-center text-center relative overflow-hidden">
                    ...
                    <p className="text-sm font-medium text-slate-400 uppercase tracking-widest mb-1 relative z-10">Labor Cost</p>
                    <p className="text-4xl font-black text-amber-400 relative z-10">{overview.labor_cost_percentage}% <span className="text-sm font-medium text-slate-500 block mt-1">dari Revenue</span></p>
                </Glass>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="space-y-6">
                    <Glass className="p-6 border-t-2 border-amber-500/50 relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="p-4 bg-black/40 rounded-xl border border-white/10">
                                ...
                                <p className="text-sm text-slate-400 leading-relaxed">Kontrak kerja akan habis dalam waktu kurang dari 30 hari. Hubungi Admin HR untuk perpanjangan atau evaluasi.</p>
                            </div>
                        </div>
                    </Glass>
                    ...
                    <div className="p-4 border border-blue-500/20 bg-blue-500/10 rounded-2xl text-blue-200 text-sm flex gap-3 items-start">
                        ...
                        <p>
                            <strong>Status Read-only:</strong> Sebagai Owner, Anda hanya dapat melihat rekap data karyawan. Untuk manajemen data, penambahan staf, atau *approval* cuti, silakan hubungi tim Admin Operasional.
                        </p>
                    </div>
                </div>
            </div>
