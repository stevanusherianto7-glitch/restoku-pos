...
export default function KatalogMenu() {
    ...
    const handleAdd = () =>
        setItems([{ id: Date.now(), name: 'Menu Baru', price: 0, category: 'Makanan', image: undefined }, ...items]);
                            ...
                            <div className="flex items-center gap-3">
                                <div className="flex items-center gap-2 rounded-lg border border-white/10 bg-white/5 px-3 py-2">
                                    ...
                                    <input
                                        ...
                                        className="bg-transparent text-sm outline-none w-32 text-slate-200 placeholder:text-slate-500"
                                    />
                                </div>
                                <button
                                    onClick={handleAdd}
