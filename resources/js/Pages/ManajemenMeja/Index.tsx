...
export default function TableManagement() {
  ...
  const getStatusColor = (status: TableStatus) => {
    switch (status) {
      ...
      case "occupied": return "bg-blue-500/20 text-blue-300 border-blue-500/30";
      case "reserved": return "bg-amber-500/20 text-amber-300 border-amber-500/30";
      case "dirty": return "bg-red-500/20 text-red-300 border-red-500/30";
    }
  };
