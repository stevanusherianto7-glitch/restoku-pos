...
export function PrinterConfig() {
            ...
            .then((data) => {
                if (data && (data.header || data.footer)) {
                    setReceiptConfig({
                        ...
                        footer:
                            data.footer ??
                            'Terima kasih sudah makan di tempat kami!\nBesar harapan kami untuk kembali lagi.',
                        ...
                        fontType:
                            data.fontType === 'font-a' || data.fontType === 'font-b' || data.fontType === 'font-c'
                                ? data.fontType
                                : 'font-a',
                        printDensity:
                            data.printDensity === 'normal' ||
                            data.printDensity === 'medium' ||
                            data.printDensity === 'dark'
                                ? data.printDensity
                                : 'normal',
    ...
    const handleSave = () => {
        ...
        const strukConfig = {
            headerText: receiptConfig.header,
            footerText: receiptConfig.footer,
    ...
    return (
        ...
        >
                ...
                <Glass className="flex-1 p-8 overflow-y-auto custom-scrollbar">
                    ...
                    {activeTab === 'kasir' && (
                        <div className="max-w-2xl animate-in fade-in duration-300 space-y-8">
                            ...
                            <div
                                className={`flex items-center justify-between p-4 rounded-lg border ${isLight ? 'bg-slate-100 border-slate-300' : 'bg-slate-900/50 border-white/10'}`}
                            >
                                <div>
                                    <div
                                ...
                                <label className="relative inline-flex items-center cursor-pointer">
                                    <input
                                        ...
                                        checked={kasirConfig.enabled}
                                        onChange={(e) => setKasirConfig({ ...kasirConfig, enabled: e.target.checked })}
                                    />
                            ...
                            <div className={`space-y-6 ${!kasirConfig.enabled && 'opacity-50 pointer-events-none'}`}>
                                ...
                                {kasirConfig.connection === 'bluetooth' && (
                                    <div className="space-y-2">
                                        ...
                                        />
                                        <p
                                            className={`text-xs ${isLight ? 'text-slate-500 font-medium' : 'text-slate-500'}`}
                                        >
                                            Contoh Windows: COM4. Contoh Linux: /dev/rfcomm0
                                        </p>
                                    </div>
                                )}
                            ...
                            >
                                ...
                                <label className="relative inline-flex items-center cursor-pointer">
                                    <input
                                        type="checkbox"
                                        className="sr-only peer"
                                        checked={dapurConfig.enabled}
                                        onChange={(e) => setDapurConfig({ ...dapurConfig, enabled: e.target.checked })}
                                    />
                                    <div className="w-11 h-6 bg-slate-700 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-emerald-500"></div>
                                </label>
                            </div>
                    ...
                    {activeTab === 'receipt' && (
                        <div className="max-w-2xl animate-in fade-in duration-300 space-y-8">
                            <div className="flex justify-between items-start">
                                <div>
                                    <h2
                                        className={`text-2xl font-bold mb-2 ${isLight ? 'text-slate-900' : 'text-white'}`}
                                    >
                                        Format Struk & Layout
                                    </h2>
                                    <p className={isLight ? 'text-slate-600 font-medium' : 'text-slate-400'}>
                                        Atur konten teks, pajak, NPWP, dan ukuran kertas untuk struk pelanggan.
                                    </p>
                                </div>
                                <Button
                                    variant="outline"
                                ...
                                <div className="col-span-2 space-y-4">
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) =>
                                                setReceiptConfig({ ...receiptConfig, header: e.target.value })
                                            }
                                            className={inputClass}
                                        />
                                    </div>
                                    <div className="space-y-2">
                                        ...
                                        <textarea
                                            ...
                                            onChange={(e) =>
                                                setReceiptConfig({ ...receiptConfig, footer: e.target.value })
                                            }
                                ...
                                <div className="col-span-2 grid grid-cols-2 gap-4">
                                    {[
                                        ...
                                        { key: 'showPbjt', label: 'Tampilkan Pajak (PBJT)', desc: 'Rincian pajak 10%' },
                                        {
                                            ...
                                            label: 'Tampilkan Service Charge',
                                            desc: 'Rincian biaya layanan',
                                        },
                                    ].map((toggle) => (
                                        <div
                                            key={toggle.key}
                                        ...
                                        >
                                            ...
                                            <label className="relative inline-flex items-center cursor-pointer">
                                                <input
                                                    ...
                                                    checked={
                                                        receiptConfig[
                                                            toggle.key as keyof typeof receiptConfig
                                                        ] as boolean
                                                    }
                                                    onChange={(e) =>
                                                        setReceiptConfig({
                                ...
                                >
                                    <div>
                                        ...
                                        <div className={`text-xs ${isLight ? 'text-slate-600' : 'text-slate-500'}`}>
                                            Membaca session karyawan yang bertugas dan menulisnya di struk
                                        </div>
                                    </div>
                                    <label className="relative inline-flex items-center cursor-pointer">
                                        <input
                                            ...
                                            onChange={(e) =>
                                                setReceiptConfig({
                                                    ...receiptConfig,
                                                    autoWriteCashier: e.target.checked,
                                                })
                                            }
                                        />
                                        <div className="w-9 h-5 bg-slate-700 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-emerald-500"></div>
                                        ...
                                        {[
                                            ...
                                            <button
                                                ...
                                                onClick={() =>
                                                    setReceiptConfig({
                                                        ...receiptConfig,
                                                        printDensity: density.id as any,
                                                    })
                                                }
                                            >
                                                {density.label}
            ...
            {showPreview && <DigitalReceiptPreview onClose={() => setShowPreview(false)} config={receiptConfig} />}
        </Screen>
    );
}
