...
import { TrendingUp, Users, DollarSign, PieChart, AlertCircle, CalendarClock, CreditCard, Activity } from "lucide-react";

export function OwnerDashboard() {


  const kpis = [
    { label: "Omzet Bulan Ini", value: "Rp 45,8jt", icon: DollarSign, trend: "+12.3%", color: "text-amber-400", bg: "bg-amber-400/10" },
    { label: "Total Pesanan", value: "1.250", icon: Activity, trend: "+8.7%", color: "text-blue-400", bg: "bg-blue-400/10" },
    { label: "Rata-rata Order", value: "Rp 36.650", icon: PieChart, trend: "+3.2%", color: "text-emerald-400", bg: "bg-emerald-400/10" },
    { label: "Okupansi Meja", value: "68%", icon: Users, trend: "+2.0%", color: "text-purple-400", bg: "bg-purple-400/10" },
  ];

  // Mock data for the chart (30 days)
  const chartData = [
    30, 45, 60, 40, 50, 70, 85, 90, 75, 60, 
    55, 65, 80, 95, 100, 85, 70, 60, 50, 45, 
    65, 75, 90, 110, 120, 100, 80, 70, 60, 85
  ];
            ...
            <div className="space-y-3">
              <div className="p-3 rounded-lg bg-red-500/10 border border-red-500/20 flex gap-3 items-start">
                ...
                <div>
                  ...
                  <p className="text-xs text-red-300/70 mt-0.5">Nasi Putih, Daging Ayam (3 menu terpengaruh)</p>
                </div>
              </div>
