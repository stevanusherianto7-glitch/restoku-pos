                    ...
                    <Glass className="p-5">
                        ...
                        <div className="space-y-4">
                            <div className="bg-amber-500/10 border border-amber-500/20 p-3 rounded-lg flex items-start gap-3">
                                <div className="size-8 rounded-full bg-slate-700 shrink-0 flex items-center justify-center text-white text-xs font-bold">
                                    BS
                                </div>
                                <div>
                            ...
                            <tbody className="divide-y divide-white/5">
                                <tr className="hover:bg-white/[0.02]">
                                    ...
                                    <td className="px-4 py-3">
                                        <Badge tone="amber">SP 1</Badge>
                                    </td>
                                    <td className="px-4 py-3 text-slate-400">02 Jul 2026</td>
                                    <td className="px-4 py-3 text-slate-300">
                                        Terlambat masuk shift &gt; 3x dalam 1 bulan
                                    </td>
                                ...
                                <tr className="hover:bg-white/[0.02]">
                                    ...
                                    <td className="px-4 py-3">
                                        <Badge tone="orange">SP 2</Badge>
                                    </td>
                                    <td className="px-4 py-3 text-slate-400">15 Jun 2026</td>
                                    <td className="px-4 py-3 text-slate-300">
                                        Merokok di area dapur (Safety violation)
                                    </td>
