                ...
                <div className="mb-6 flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-sm text-slate-400">
                            Absensi di bawah ini tercatat namun di luar radius toleransi lokasi outlet. Silakan periksa
                            foto selfie untuk memverifikasi.
                        </p>
                    </div>
                </div>
                                ...
                                >
                                    ...
                                    <td className="py-4">
                                        <div className="flex items-center gap-1.5">
                                            ...
                                            />
                                            <span
                                                className={`text-sm font-medium ${item.distance > 50 ? 'text-amber-400' : 'text-emerald-400'}`}
                                            >
                                                {item.distance} meter
                                            </span>
                                        </div>
