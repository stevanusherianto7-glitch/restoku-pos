                            ...
                            {stockAlerts.map((item) => (
                                <tr key={item.id} className="hover:bg-white/5 transition-colors">
                                    ...
                                    <td className="px-4 py-3">
                                        <span
                                            className={`font-semibold ${item.status === 'danger' ? 'text-red-400' : item.status === 'warning' ? 'text-amber-400' : 'text-slate-200'}`}
                                        >
                                            {item.stock}
                                        </span>{' '}
                                    ...
                                    <td className="px-4 py-3">
                                        {item.min} <span className="text-slate-500">{item.unit}</span>
                                    </td>
                                    <td className="px-4 py-3">
                                        {formatRp(item.cost)}
