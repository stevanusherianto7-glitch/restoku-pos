...
export function RecipeEditor() {
  ...
  const recipeItems = [
    { id: 1, name: "Nasi Putih", qty: 0.300, unit: "kg", cost: 3000 },
    { id: 2, name: "Telur Ayam", qty: 2, unit: "butir", cost: 4000 },
    { id: 3, name: "Bawang Merah", qty: 0.020, unit: "kg", cost: 600 },
    { id: 4, name: "Bawang Putih", qty: 0.010, unit: "kg", cost: 400 },
    { id: 5, name: "Cabai Merah", qty: 0.010, unit: "kg", cost: 500 },
  ];
  ...
  return (
    <Screen title="Editor Resep & BOM" action={
      <div className="flex gap-2">
        <Button variant="outline" className="gap-2"><ChevronLeft className="size-4" /> Kembali</Button>
        <Button className="gap-2 bg-emerald-600 hover:bg-emerald-700"><Save className="size-4" /> Simpan Resep</Button>
      </div>
    }>
          ...
          <Glass className="p-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
              <div>
                ...
                <p className="text-sm text-slate-400">Resep untuk menu: <strong className="text-white">Nasi Goreng Spesial</strong></p>
              </div>
              <Button className="gap-2"><Plus className="size-4" /> Tambah Bahan</Button>
            </div>
                  ...
                  {recipeItems.map((item) => (
                    <tr key={item.id} className="hover:bg-white/5 transition-colors">
                      ...
                      <td className="px-4 py-3">
                        <Input type="number" defaultValue={item.qty} className="w-24 text-right py-1 h-8" />
                      </td>
            ...
            <div className="mt-4 p-4 rounded-lg bg-blue-500/10 border border-blue-500/20 flex gap-3">
              ...
              <p className="text-sm text-blue-200">
                Setiap kali menu ini terjual, stok bahan baku di atas akan otomatis dikurangi dari inventaris berdasarkan takaran.
              </p>
            </div>
          </Glass>
        </div>
          ...
          <Glass className="p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center pb-4 border-b border-white/10">
                ...
                <div className="w-32">
                  <Input 
                    type="number" 
                    value={sellingPrice} 
                    onChange={(e: ChangeEvent<HTMLInputElement>) => setSellingPrice(Number(e.target.value))}
              ...
              <div className="flex justify-between items-center pb-4 border-b border-white/10">
                ...
                <Badge tone={parseFloat(foodCostPct) > 40 ? "red" : parseFloat(foodCostPct) > 30 ? "amber" : "emerald"}>
                  {foodCostPct}%
                </Badge>
              </div>
              ...
              <div className="flex justify-between items-center pt-2">
                ...
                <span className={`text-xl font-bold ${grossProfit > 0 ? 'text-emerald-400' : 'text-red-400'}`}>
