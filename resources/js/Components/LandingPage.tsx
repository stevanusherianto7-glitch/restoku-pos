            ...
            <header className="sticky top-0 z-50 flex items-center justify-between px-6 md:px-12 py-4 bg-[#0a382e] text-white">
                ...
                <div className="flex items-center gap-4">
                    <button
                        ...
                        className="hidden md:block text-sm font-semibold text-emerald-50 hover:text-white transition-colors"
                    >
                        Login Owner
                    </button>
                    <button
                        onClick={onEnter}
                        className="px-5 py-2 text-sm font-semibold text-[#0a382e] bg-white rounded-full hover:bg-emerald-50 transition-colors"
                    >
                        Login Staf & Kasir
                    </button>
                </div>
            ...
            <main className="flex-1 flex flex-col items-center">
                    ...
                    <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                        ...
                        <div className="flex flex-col items-start z-10">
                            ...
                            <p className="text-lg text-slate-600 mb-8 max-w-lg leading-relaxed">
                                Kelola penjualan, pesanan, operasional, hingga laporan dalam satu platform yang mudah,
                                cepat, dan akurat.
                            </p>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 mb-10 w-full sm:w-auto">
                                <button
                                    onClick={onEnter}
                                    className="px-6 py-3.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-semibold text-base shadow-lg shadow-emerald-600/20 transition-all hover:-translate-y-0.5 flex items-center justify-center gap-2"
                                >
                                    Login Staf (POS/KDS) <ArrowRight className="size-4" />
                                </button>
                                <button
                                    onClick={onEnterOwner}
                                    className="px-6 py-3.5 bg-white hover:bg-slate-50 text-emerald-700 border border-emerald-200 rounded-xl font-semibold text-base transition-all flex items-center justify-center"
                                >
                            ...
                            <div className="flex flex-wrap items-center gap-x-6 gap-y-3 text-sm font-medium text-slate-600 mb-10">
                                <span className="flex items-center gap-1.5">
                                    <CheckCircle2 className="size-4 text-emerald-500" /> Mudah digunakan
                                </span>
                                <span className="flex items-center gap-1.5">
                                    <CheckCircle2 className="size-4 text-emerald-500" /> Data real-time
                                </span>
                                <span className="flex items-center gap-1.5">
                                    <CheckCircle2 className="size-4 text-emerald-500" /> Aman & Terpercaya
                                </span>
                            </div>

                            <div className="flex items-center gap-4">
                                <div className="flex -space-x-3">
                                    <div className="size-10 rounded-full border-2 border-white bg-slate-200 flex items-center justify-center overflow-hidden">
                        ...
                        <div className="relative w-full h-[500px] lg:h-[600px] flex justify-center items-center perspective-1000 z-10">
                            {/* Decorative Bubbles */}
                            <div
                                className="absolute top-10 right-20 size-8 rounded-full bg-emerald-400/80 shadow-lg shadow-emerald-400/50 animate-bounce"
                            ...
                            <div
                                className="absolute top-1/2 -right-4 size-6 rounded-full bg-blue-400/60 shadow-lg shadow-blue-400/40 animate-bounce"
                                style={{ animationDuration: '4s' }}
                            />

                            {/* Mockup Container */}
                            <div
                                className="relative w-[110%] max-w-2xl transform rotate-y-[-15deg] rotate-x-[5deg] rotate-z-[2deg] shadow-2xl rounded-2xl bg-[#1e2329] border border-slate-700/50 overflow-hidden"
                                style={{
                                    ...
                                    <div className="flex flex-1 overflow-hidden h-[450px]">
                                        ...
                                        <div className="w-48 bg-[#181c20] p-4 flex flex-col gap-2 border-r border-slate-700/50">
                                            <div className="flex items-center gap-2 mb-6 text-white font-bold">
                                                <ChefHat className="size-5" /> Restoku OS
                                            </div>
                                            {['Dashboard', 'Kasir (POS)', 'Dapur (KDS)', 'Laporan', 'Pengaturan'].map(
                                                (item, i) => (
                                                    <div
                                                        key={i}
                                                        className={`px-3 py-2 rounded-md text-xs font-medium ${i === 0 ? 'bg-slate-700 text-white' : 'text-slate-400'}`}
                                                    >
                                                        {item}
                                                    </div>
                                                ),
                                        ...
                                        <div className="flex-1 bg-[#1e2329] p-6">
                                            <div className="flex justify-between items-center mb-6">
                                                ...
                                                <div className="px-3 py-1.5 bg-blue-600 rounded text-white text-xs font-semibold">
                                                    Buka Kasir
                                                </div>
                                            </div>
                                            ...
                                            <div className="bg-[#2a3038] p-4 rounded-xl border border-slate-600/30 h-32 flex items-end gap-1.5 justify-between">
                                                {[30, 50, 40, 70, 90, 60, 80, 45, 55, 100, 75, 85].map((val, i) => (
                                                    <div
                                                        key={i}
                                                        className="w-full bg-gradient-to-t from-emerald-500 to-blue-400 rounded-t-sm"
                                                        style={{ height: `${val}%` }}
                                                    />
                                                ))}
                                            </div>
                ...
                <section className="w-full border-y border-slate-100 bg-white py-10 px-6">
                    <div className="max-w-6xl mx-auto flex flex-col items-center">
                        <p className="text-sm font-semibold text-slate-500 uppercase tracking-wider mb-8">
                            Dipercaya oleh ribuan bisnis kuliner di Indonesia
                        </p>
                ...
                <section id="features" className="w-full bg-slate-50 py-24 px-6">
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-16">
                            <div className="text-emerald-600 font-bold text-xs tracking-widest uppercase mb-3">
                                Semua Fitur Dalam Satu Platform
                            </div>
                            <h2 className="text-3xl md:text-4xl font-bold text-slate-900">
                                Operasional Lebih Ringkas & Efisien
                            </h2>
                        </div>
                            ...
                            {[
                                {
                                    ...
                                    desc: 'Proses transaksi cepat, multi payment, dan terintegrasi dengan stok.',
                                ...
                                },
                                {
                                    ...
                                    desc: 'Pesanan langsung ke dapur, mengurangi kesalahan & waktu tunggu.',
                                    color: 'text-blue-600',
                                    bg: 'bg-blue-100',
                                },
                                {
                                    ...
                                    desc: 'Menu digital interaktif untuk pengalaman pelanggan yang lebih modern.',
                                ...
                                >
                                    <div
                                        className={`size-12 rounded-xl ${feat.bg} flex items-center justify-center mb-6`}
                                    >
                        ...
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                ...
                                <h2 className="text-3xl font-bold text-slate-900 mb-5 leading-tight">
                                    Keputusan Lebih Cepat dengan Data Akurat
                                </h2>
                                <p className="text-slate-600 mb-8 leading-relaxed">
                                    Pantau penjualan, menu terlaris, stok, dan performa outlet secara real-time dari
                                    mana saja.
                                </p>
                            ...
                            <div className="bg-white p-6 rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100">
                                ...
                                <div className="grid grid-cols-3 gap-4 mb-8">
                                    ...
                                    <div className="p-4 bg-slate-50 rounded-xl border border-slate-100">
                                        ...
                                        <div className="text-emerald-600 text-xs font-semibold flex items-center gap-1">
                                            <TrendingUp className="size-3" /> 8.7%
                                        </div>
                                    </div>
                                </div>
                                {/* Fake Line Chart */}
                                <div className="relative h-48 w-full border-b border-slate-100 flex items-end justify-between px-2 pb-6">
                                    ...
                                    >
                                        <path
                                            d="M0,80 C20,60 30,90 50,40 C70,-10 80,70 100,20"
                                            fill="none"
                                            stroke="#10b981"
                                            strokeWidth="2"
                                        ...
                                        />
                                        <path
                                            d="M0,80 C20,60 30,90 50,40 C70,-10 80,70 100,20 L100,100 L0,100 Z"
                                            fill="url(#grad)"
                                            opacity="0.2"
                                        />
                                        <defs>
                                    ...
                                    {['8 Mei', '9 Mei', '10 Mei', '11 Mei', '12 Mei', '13 Mei'].map((day) => (
                                        <div
                                            key={day}
                                            className="text-[10px] text-slate-400 font-medium z-10 translate-y-8"
                                        >
                                            {day}
                                        </div>
                                    ))}
                                    ...
                                    <div className="absolute top-[30%] left-[48%] bg-slate-900 text-white text-[10px] py-1 px-2 rounded shadow-lg">
                                        12 Mei
                                        <br />
                                        <span className="font-bold">Rp 14.2M</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section id="pricing" className="w-full bg-[#072f24] py-24 px-6 relative overflow-hidden">
                    ...
                    <div className="max-w-5xl mx-auto relative z-10">
                        <div className="text-center mb-16">
                            <div className="text-emerald-400 font-bold text-xs tracking-widest uppercase mb-3">
                                Paket Harga
                            </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-6 items-center">
                            ...
                            <div className="bg-white rounded-3xl p-8 flex flex-col shadow-xl">
                                <div className="flex items-center gap-3 mb-4">
                                    <div className="size-10 rounded-xl bg-emerald-100 flex items-center justify-center">
                                        <LayoutTemplate className="size-5 text-emerald-600" />
                                    </div>
                                    <div>
                                ...
                                <div className="text-3xl font-black text-slate-900 mb-6">
                                    Rp 149rb<span className="text-sm font-normal text-slate-500">/bln</span>
                                </div>
                                ...
                                <Link
                                    ...
                                    className="w-full py-3 rounded-xl border-2 border-slate-200 text-slate-700 font-bold hover:border-emerald-600 hover:text-emerald-700 transition-colors text-center"
                                >
                                    Mulai Basic
                                </Link>
                            </div>
                            ...
                            <div className="bg-white rounded-3xl p-8 flex flex-col shadow-2xl relative md:-translate-y-4 border-2 border-emerald-500">
                                ...
                                <div className="text-4xl font-black text-slate-900 mb-6">
                                    Rp 399rb<span className="text-sm font-normal text-slate-500">/bln</span>
                                </div>
                                <ul className="space-y-4 mb-8 flex-1">
                                    {[
                                        'Hingga 3 Outlet',
                                ...
                                <Link
                                    href="/subscribe/pro"
                                    className="w-full py-3 rounded-xl bg-emerald-500 hover:bg-emerald-600 text-white font-bold transition-colors shadow-lg shadow-emerald-500/20 text-center"
                                >
                                    Coba Pro Gratis
                                </Link>
                            </div>
                            ...
                            <div className="bg-white rounded-3xl p-8 flex flex-col shadow-xl">
                                ...
                                <div className="text-3xl font-black text-slate-900 mb-6">
                                    Rp 999rb<span className="text-sm font-normal text-slate-500">/bln</span>
                                </div>
                                <ul className="space-y-4 mb-8 flex-1">
                                    {[
                ...
                <section id="testimonials" className="w-full bg-slate-50 py-24 px-6">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            {[
                                {
                                    text: 'Restoku sangat membantu operasional restoran kami jadi lebih efisien dan terkontrol.',
                                    name: 'Andi Wijaya',
                                    role: 'Owner Waroeng Steak',
                                    img: 'https://i.pravatar.cc/150?img=11',
                                },
                                {
                                    text: 'Fitur laporan real-time sangat akurat, membantu kami ambil keputusan lebih cepat.',
                                    name: 'Sari Mulyani',
                                    role: 'Manager Operasional Solaria',
                                    img: 'https://i.pravatar.cc/150?img=5',
                                },
                                {
                                    text: 'Integrasi dengan GoFood & Grab memudahkan kami kelola semua pesanan.',
                                    name: 'Budi Santoso',
                                    role: 'CEO Bakmi GM',
                    ...
                    <div className="max-w-5xl mx-auto bg-emerald-700 rounded-3xl p-10 md:p-14 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden">
                        ...
                        <div className="relative z-10 flex-1 text-center md:text-left">
                            <h2 className="text-2xl md:text-3xl font-bold text-white mb-3">
                                Siap Tingkatkan Efisiensi Restoran Anda?
                            </h2>
                            <p className="text-emerald-100 text-sm">
                                Bergabunglah dengan ribuan bisnis kuliner yang sudah sukses bersama Restoku.
                            </p>
                        </div>
                        <div className="relative z-10 flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                            <button
                                onClick={onEnter}
                                className="px-6 py-3 bg-white text-emerald-800 font-bold rounded-xl hover:bg-emerald-50 transition-colors whitespace-nowrap"
                            >
                                Login Staf & Kasir
                            </button>
                            <button
                                onClick={onEnterOwner}
                                className="px-6 py-3 bg-transparent border border-emerald-400 text-white font-bold rounded-xl hover:bg-emerald-600/50 transition-colors whitespace-nowrap"
                            >
                                Login Owner
                            </button>
                        </div>
                ...
                <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
                    <div className="col-span-2">
                        <div className="flex items-center gap-2 mb-6">
                            <div className="size-8 rounded-lg bg-white text-[#041d16] flex items-center justify-center">
                        ...
                        <div className="flex gap-4">
                            <div className="size-8 rounded-full bg-white/10 flex items-center justify-center cursor-pointer hover:bg-emerald-500 transition-colors">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-xs text-emerald-200/70">
                            <li className="flex items-center gap-2">
                                <Smartphone className="size-3" /> 0812-3456-7890
                            </li>
                            <li className="flex items-center gap-2">
                                <Star className="size-3" /> hello@restoku.com
                            </li>
                            <li className="flex items-center gap-2">
                                <Clock className="size-3" /> Senin - Jumat (09:00 - 18:00)
                            </li>
                        </ul>
                    </div>
                </div>
