                ...
                <div className="space-y-6">
                    <Glass className="p-6">
                        ...
                        <p className="text-sm text-slate-400 mb-6 max-w-2xl">
                            Buat dan cetak kode QR untuk ditempel di setiap meja. Pelanggan dapat memindai QR ini untuk
                            membuka menu digital dan memesan langsung dari *smartphone* mereka.
                        </p>
                            ...
                            <div className="flex justify-between items-center mb-6">
                                <div>
                                    ...
                                    <p className="text-sm text-slate-400">
                                        Ukuran cetak standar: 8x8 cm (Kertas Vinyl/Art Paper)
                                    </p>
                                </div>
                                <div className="flex gap-2">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 place-items-center bg-slate-900/50 p-6 rounded-xl border border-white/5 max-h-[600px] overflow-y-auto">
                                ...
                                {parseInt(tableCount) > 20 && (
                                    <div className="col-span-full py-8 text-slate-500 italic text-sm">
                                        ... dan {parseInt(tableCount) - 20} QR lainnya akan disertakan dalam file
                                        unduhan/cetak.
                                    </div>
                                )}
                            </div>
                ...
                <Glass className="p-6">
                    <div className="flex justify-between items-center mb-6">
                        <div>
                            ...
                            <p className="text-sm text-slate-400">
                                QR Code unik per karyawan untuk scan masuk/keluar shift.
                            </p>
                        </div>
                        <Button variant="outline" className="gap-2">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <Glass className="p-6">
                        ...
                        <p className="text-sm text-slate-400 mb-6">
                            Gunakan QR ini untuk dipasang di banner depan toko, brosur, atau sosial media. Pelanggan
                            dapat melihat menu tanpa terikat pada nomor meja tertentu.
                        </p>
