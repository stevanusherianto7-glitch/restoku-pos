                ...
                <div className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                        <Glass className="p-6">
                            ...
                            <h3 className="text-2xl font-bold tracking-tight text-slate-100 mt-1">
                        ...
                        <Glass className="p-6">
                            ...
                            <h3 className="text-2xl font-bold tracking-tight text-slate-100 mt-1 font-mono">
                                {formatRupiah(parseInt(openingBalance))}
                            </h3>
                        </Glass>
                        ...
                        <Glass className="p-6">
                            ...
                            <h3 className="text-2xl font-bold tracking-tight text-slate-100 mt-1 font-mono">
                                {formatRupiah(currentSession.totalCashSales)}
                            </h3>
                            <p className="text-xs text-slate-500 mt-2">
                                Ekspektasi Uang di Laci: {formatRupiah(expectedCash)}
                            </p>
                        </Glass>
                    </div>
                    ...
                    <Glass className="p-6">
                        ...
                        {[
                            ...
                            <div
                                key={row.id}
                                className="grid grid-cols-[1fr_1.5fr_1.5fr_1.5fr_1fr] items-center border-b border-white/5 py-3 text-sm"
                            >
                                ...
                                <span
                                    className={`font-mono font-medium ${row.diff === 0 ? 'text-emerald-400' : 'text-red-400'}`}
                                >
                                    {row.diff === 0 ? '-' : formatRupiah(row.diff)}
                                </span>
                                <span>
                                    {row.status === 'Cocok' ? (
                                        <Badge tone="emerald">Sesuai</Badge>
                                    ) : (
                                        <Badge tone="red">Selisih</Badge>
                                    )}
                                </span>
                            </div>
                        ))}
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
                    <Glass className="p-6 max-w-lg w-full">
                        <div className="flex justify-between items-start mb-6">
                            <div>
                                ...
                                <p className="text-sm text-slate-400 mt-1">
                                    Lakukan rekonsiliasi uang laci (Z-Report).
                                </p>
                            </div>
                            <button
                        ...
                        <div className="space-y-4 mb-6">
                            ...
                            {difference !== 0 && (
                                ...
                                >
                                    ...
                                    <div>
                                        <p
                                            className={`text-sm font-medium ${difference > 0 ? 'text-emerald-400' : 'text-red-400'}`}
                                        >
                                        ...
                                        <Input
                                            ...
                                            className="mt-3 text-xs bg-black/20"
                                        />
                                    </div>
                                </div>
                            )}
                        ...
                        <div className="flex justify-end gap-3 pt-4 border-t border-white/10">
                            <Button variant="ghost" onClick={() => setIsClosingModalOpen(false)}>
                                Batal
                            </Button>
                            <Button
